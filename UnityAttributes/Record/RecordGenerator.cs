...
[Generator]
public class RecordGenerator : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterPostInitializationOutput(i => i.AddSource($"{RecordAttribute.AttributeFullName}.g", RecordAttribute.AttributeText));
    ...
    private static Optional<ClassToProcess> GetSemanticTargetForGeneration(GeneratorSyntaxContext ctx, CancellationToken token)
    {
        ...
        if (!classDeclarationSyntax.HaveAttribute(RecordAttribute.AttributeName))
        {
