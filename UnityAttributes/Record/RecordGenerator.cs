...
public partial class RecordGenerator : ISourceGenerator {
  ...
  public void Execute(GeneratorExecutionContext context) {
    ...
    foreach (var (classSymbol, fieldsSymbols) in receiver.classes) {
      ...
      context.AddSource($"{classSymbol.Name}.record.g.cs", SourceText.From(classSource, Encoding.UTF8));
    }
  }
  ...
  public void OnVisitSyntaxNode(GeneratorSyntaxContext context) {
    ...
    if (haveAttribute) {
      var fields = classDeclarationSyntax
        ...
        .Select(field => context.SemanticModel.GetDeclaredSymbol(field) as IFieldSymbol)
        .ToArray();
